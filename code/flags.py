...
tf.app.flags.DEFINE_float("learning_decay_rate", 0.88, "How much the learning rate should decay in an epoch.")
tf.app.flags.DEFINE_float("max_gradient_norm", 100, "Clip gradients to this norm.")
...
# preprocessing
tf.app.flags.DEFINE_integer("max_context_len", 400, "The length we will clip/pad a context paragraph to")
